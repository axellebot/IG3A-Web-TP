...
\draw (current page.center) node [fill=ocre!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering Module ITC315 - Web\\[15pt] % Book title
{\Large Compte-rendu de travaux pratiques}\\[20pt] % Subtitle
{\huge Basile DUTERTE | Léonard GÉHIN | Axel LE BOT | Andrew LENC}\\ % Author name
}};
\end{tikzpicture}
\vfill
\endgroup
...
%Ce rapport contient le compte-rendu des travaux pratiques de développement web (Module ITC34).\\
